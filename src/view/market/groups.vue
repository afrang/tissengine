                    ...
                    <div class="card  cell   text-right" v-for="(item,index) in items.data" :key="index">
                        <a class="mylink" :href="'/product/'+item.url">
                                <div class="  animated  ">
                                    ...
                                    <div class="float-left"  style="margin-top:-15px; z-index: 5000; position: absolute; ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <template v-if="item.status==1">
                                            <a v-if="item.price!=0" href="#" class="btn btn-primary">
                                              ...
                                              <template v-if="item.discount!=0 || item.discount!=null">
    ...
    export default {
        ...
        computed:{
            filterobejct:function () {
                let object={};
                object.group=this.$route.params.url;
        ...
        methods:{
            ...
            callcate(){
                let that=this;
                this.$axios.get(this.$url+'pgroup/'+that.$route.params.url)
                    .then(function (res) {
            ...
            search(){
                let that=this;
                let data={
                    group:that.$route.params.url
                }
                this.$axios.get(this.$url+'psearch',{
                    params: {
                        page: this.page,
                        attr:this.attr,
                        group:this.$route.params.url,
                        feature:this.faeat,
